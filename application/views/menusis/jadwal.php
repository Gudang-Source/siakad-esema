                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="datatable-ct">
                                        <!-- <a href="<echo base_url('C_admin/editjadwal/'.$value->kode_kelas.'/'.$value->kode_mp) ?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a> -->
